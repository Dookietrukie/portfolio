  ...
  const projects = [
    {
      title: "PetHub",
      description:
        "PetHub is a web app that allows it's users to register pets just to display them, or to put them for adoption, in adoption bundles. In this project I worked alongside a mate both in the frontend and in the backend.",
    ...
    },
    {
      ...
      description:
        "Bytes & Dungeons is a web app that allows it's users to create, view, edit and delete fantasy characters. It also allows the users to play with their characters against other players in a real-time 1v1 'Rock, Paper, Scissors' kind of match",
